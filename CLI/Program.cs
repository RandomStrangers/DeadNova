    ...
    public static class Program {
        ...
        public static void Main(string[] args) {
            ...
            try {
                ...
                Console.WriteLine("Cannot start server as DeadNova_.dll is missing from " + Environment.CurrentDirectory);
        ...
        static void EnableCLIMode() {
            try {
                ...
                // in case user is running CLI with older DeadNova dll which lacked CLIMode field
            }
...
#if DEV_BUILD_NOVA
            if (!Server.Config.NovaLogging[(int)type]) return;
#else
