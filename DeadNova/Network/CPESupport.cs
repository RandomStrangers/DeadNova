...
namespace DeadNova 
{
    ...
    public sealed class CpeExtension 
    {
        ...
        public static CpeExtension[] All = new CpeExtension[] {
            ...
            new CpeExtension(CpeExt.EnvMapAspect,        "Allows customising map appearance (/Env and /Texture)", 2),            new CpeExtension(CpeExt.PlayerClick,         "Allows retrieving precise details on mouse clicks"),
